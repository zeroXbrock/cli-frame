// credit: https://web.archive.org/web/20000918113202/http://www.ludd.luth.se/~vk/pics/ascii/junkyard/creative/animations/globe_animation.html

pub const GLOBE: [&'static str; 30] = [
    " 
                   _-o#&&*''''?d:>b\\_
               _o/\"`''  '',, dMF9MMMMMHo_
            .o&#'        `\"MbHMMMMMMMMMMMHo.
